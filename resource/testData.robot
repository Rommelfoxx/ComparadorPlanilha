...
@{template_row1}=   1   Douglas     Morris      morris0@mozilla.org    Male    205.4.212.229
...
&{template_dict_row1}=      id=1   first_name=Douglas       last_name=Morris    email=morris0@mozilla.org      gender=Male     ip_address=205.4.212.229
